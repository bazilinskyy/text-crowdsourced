...
jsPsych.plugins['image-slider-response'] = (function() {
  ...
  plugin.trial = function(display_element, trial) {
    ...
    var html = '<div id="jspsych-image-slider-response-wrapper" style="margin: 0px 0px;">';
    ...
    for(var j=0; j < trial.labels.length; j++){
      ...
      html += '<div style="display: inline-block; position: absolute; left:'+left_offset+'%; text-align: center; width: '+width+'%; line-height: normal">';
